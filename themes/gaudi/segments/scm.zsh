...
GAUDI_THEME_PROMPT_CLEAN_COLOR="${WHITE}${BACKGROUND_GREEN}"
GAUDI_THEME_PROMPT_DIRTY_COLOR="${WHITE}${BACKGROUND_RED}"
GAUDI_THEME_PROMPT_STAGED_COLOR="${BLACK}${BACKGROUND_ORANGE}"
GAUDI_THEME_PROMPT_UNSTAGED_COLOR="${BLACK}${BACKGROUND_YELLOW}"
